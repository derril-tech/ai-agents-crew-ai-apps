...
from .models import Base, User, Learning, Path, Progress
from .schemas import LearningCreate, PathCreate, ProgressCreate
...
@app.get("/")
async def root():
    return {"message": "Learning Path Generator API"}
