...
from .models import Base, User, Storyboard, Scene, Visual
from .schemas import StoryboardCreate, SceneCreate, VisualCreate
...
@app.get("/")
async def root():
    return {"message": "Dynamic Video Storyboard Creator API"}
...
async def health_check():
    return {"status": "healthy", "service": "dynamic-video-storyboard-creator"}
