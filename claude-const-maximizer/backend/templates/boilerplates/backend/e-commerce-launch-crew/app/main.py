...
from .models import Base, User, Store, Product, Launch
from .schemas import StoreCreate, ProductCreate, LaunchCreate
...
@app.get("/")
async def root():
    return {"message": "E-commerce Launch Crew API"}
...
async def health_check():
    return {"status": "healthy", "service": "e-commerce-launch-crew"}
