...
A FastAPI backend boilerplate for synthetic data generator with ai-powered data creation.
...
DATABASE_URL=postgresql://user:password@localhost/ai_powered_synthetic_data_generator_db
```
