...
from .models import Base, User, Prospect, Lead, Campaign
from .schemas import ProspectCreate, LeadCreate, CampaignCreate
...
@app.get("/")
async def root():
    return {"message": "B2B Sales Prospecting AI API"}
...
async def health_check():
    return {"status": "healthy", "service": "b2b-sales-prospecting-ai"}
