...
A FastAPI backend boilerplate for resume parsing and job matching system with ai-powered analysis.

## Features

- **AI-Powered Analysis**: Basic structure for OpenAI integration
- **Data Management**: Core data models for resume, job, match
- **JWT Authentication**: Basic security setup
- **Skill Extraction**: Foundation for skill extraction
...
DATABASE_URL=postgresql://user:password@localhost/ai_powered_resume_parser_&_job_matcher_db
```
