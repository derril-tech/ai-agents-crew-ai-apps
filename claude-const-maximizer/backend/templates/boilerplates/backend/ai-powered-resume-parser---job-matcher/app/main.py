...
from .schemas import ResumeCreate, JobCreate, MatchCreate
...
@app.get("/")
async def root():
    return {"message": "AI-Powered Resume Parser & Job Matcher API"}
...
async def health_check():
    return {"status": "healthy", "service": "ai-powered-resume-parser-&-job-matcher"}
