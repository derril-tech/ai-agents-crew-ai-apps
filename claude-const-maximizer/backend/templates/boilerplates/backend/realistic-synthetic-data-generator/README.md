...
A FastAPI backend boilerplate for synthetic data generation system with ai-powered realism.

## Features

- **AI-Powered Analysis**: Basic structure for OpenAI integration
- **Data Management**: Core data models for dataset, generation, schema
- **JWT Authentication**: Basic security setup
- **Data Privacy**: Foundation for data privacy
...
DATABASE_URL=postgresql://user:password@localhost/realistic_synthetic_data_generator_db
```
