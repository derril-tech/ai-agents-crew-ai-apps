...
A FastAPI backend boilerplate for ai-powered email campaign creation and optimization.

## Features

- **AI-Powered Analysis**: Basic structure for OpenAI integration
- **Data Management**: Core data models for campaign, email, template
- **JWT Authentication**: Basic security setup
- **Email Templates**: Foundation for email templates
...
DATABASE_URL=postgresql://user:password@localhost/ai_email_campaign_writer_db
```
