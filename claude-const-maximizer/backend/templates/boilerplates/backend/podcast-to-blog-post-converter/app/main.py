...
from .models import Base, User, Podcast, Transcription, Blog
from .schemas import PodcastCreate, TranscriptionCreate, BlogCreate
...
@app.get("/")
async def root():
    return {"message": "Podcast to Blog Post Converter API"}
...
async def health_check():
    return {"status": "healthy", "service": "podcast-to-blog-post-converter"}
