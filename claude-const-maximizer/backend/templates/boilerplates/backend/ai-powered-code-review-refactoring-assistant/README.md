...
A FastAPI backend boilerplate for code review and refactoring system with ai-powered suggestions.

## Features

- **AI-Powered Analysis**: Basic structure for OpenAI integration
- **Data Management**: Core data models for project, review, suggestion
...
DATABASE_URL=postgresql://user:password@localhost/ai_powered_code_review_&_refactoring_assistant_db
```
