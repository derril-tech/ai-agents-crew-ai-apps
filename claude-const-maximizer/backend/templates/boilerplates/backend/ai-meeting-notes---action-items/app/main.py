...
from .models import Base, User, Meeting, Note, ActionItem
from .schemas import MeetingCreate, NoteCreate, ActionItemCreate
...
@app.get("/")
async def root():
    return {"message": "AI Meeting Notes & Action Items API"}
...
async def health_check():
    return {"status": "healthy", "service": "ai-meeting-notes-&-action-items"}
