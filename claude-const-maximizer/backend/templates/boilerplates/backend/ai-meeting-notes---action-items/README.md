...
A FastAPI backend boilerplate for ai-powered meeting transcription and action item extraction.

## Features

- **AI-Powered Analysis**: Basic structure for OpenAI integration
- **Data Management**: Core data models for meeting, note, actionitem
...
DATABASE_URL=postgresql://user:password@localhost/ai_meeting_notes_&_action_items_db
```
