...
from .models import Base, User, Conference, Event, Schedule
from .schemas import ConferenceCreate, EventCreate, ScheduleCreate
...
@app.get("/")
async def root():
    return {"message": "Conference Planning Crew API"}
...
async def health_check():
    return {"status": "healthy", "service": "conference-planning-crew"}
