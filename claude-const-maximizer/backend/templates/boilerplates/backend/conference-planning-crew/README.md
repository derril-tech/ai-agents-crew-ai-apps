...
A FastAPI backend boilerplate for conference planning system with ai-powered event management.

## Features

- **AI-Powered Analysis**: Basic structure for OpenAI integration
- **Data Management**: Core data models for conference, event, schedule
- **JWT Authentication**: Basic security setup
- **Venue Management**: Foundation for venue management
...
DATABASE_URL=postgresql://user:password@localhost/conference_planning_crew_db
```
