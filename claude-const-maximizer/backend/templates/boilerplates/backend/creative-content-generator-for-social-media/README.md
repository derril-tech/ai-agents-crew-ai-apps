...
A FastAPI backend boilerplate for social media content generation system with ai-powered creativity.

## Features

- **AI-Powered Analysis**: Basic structure for OpenAI integration
- **Data Management**: Core data models for content, platform, creative
- **JWT Authentication**: Basic security setup
- **Social Media Api**: Foundation for social media api
...
DATABASE_URL=postgresql://user:password@localhost/creative_content_generator_for_social_media_db
```
