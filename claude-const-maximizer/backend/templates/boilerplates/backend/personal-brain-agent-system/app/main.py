...
from .models import Base, User, Knowledge, Memory, Agent
from .schemas import KnowledgeCreate, MemoryCreate, AgentCreate
...
@app.get("/")
async def root():
    return {"message": "Personal Brain Agent System API"}
...
async def health_check():
    return {"status": "healthy", "service": "personal-brain-agent-system"}
