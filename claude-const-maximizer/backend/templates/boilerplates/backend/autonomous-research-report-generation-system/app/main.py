...
from .models import Base, User, Research, Report, Generation
from .schemas import ResearchCreate, ReportCreate, GenerationCreate
...
async def health_check():
    return {"status": "healthy", "service": "autonomous-research-&-report-generation-system"}
