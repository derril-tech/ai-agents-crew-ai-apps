...
from .models import Base, User, Candidate, Position, Flow
from .schemas import CandidateCreate, PositionCreate, FlowCreate
...
@app.get("/")
async def root():
    return {"message": "Recruitment Flow AI API"}
...
async def health_check():
    return {"status": "healthy", "service": "recruitment-flow-ai"}
