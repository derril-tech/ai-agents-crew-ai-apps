...
A FastAPI backend boilerplate for resume and cover letter personalization system.

## Features

- **AI-Powered Analysis**: Basic structure for OpenAI integration
- **Data Management**: Core data models for resume, coverletter, personalization
...
DATABASE_URL=postgresql://user:password@localhost/resume_&_cover_letter_personalizer_db
```
