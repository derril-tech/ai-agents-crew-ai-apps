...
services:
  - type: web
    name: ai-email-campaign-writer-api
    env: python
...
NEXT_PUBLIC_API_BASE_URL=https://ai-email-campaign-writer-api.onrender.com
...
"Create the FastAPI backend for the AI Email Campaign Writer with ai platform specific endpoints and integrations. Include AI processing and specialized functionality."
...
**This 1-page document provides Claude with everything needed to build a production-ready AI Email Campaign Writer in exactly 3 prompts!** 🚀
