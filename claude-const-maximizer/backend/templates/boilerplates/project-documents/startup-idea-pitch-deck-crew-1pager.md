...
services:
  - type: web
    name: startup-idea-pitch-deck-crew-api
    env: python
...
NEXT_PUBLIC_API_BASE_URL=https://startup-idea-pitch-deck-crew-api.onrender.com
...
"Create the FastAPI backend for the Startup Idea to Pitch Deck Crew with ai platform specific endpoints and integrations. Include AI processing and specialized functionality."
...
**This 1-page document provides Claude with everything needed to build a production-ready Startup Idea to Pitch Deck Crew in exactly 3 prompts!** 🚀
