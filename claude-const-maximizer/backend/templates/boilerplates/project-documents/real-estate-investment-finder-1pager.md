...
services:
  - type: web
    name: real-estate-investment-finder-api
    env: python
...
NEXT_PUBLIC_API_BASE_URL=https://real-estate-investment-finder-api.onrender.com
...
"Create the FastAPI backend for the Real Estate Investment Finder with ai platform specific endpoints and integrations. Include AI processing and specialized functionality."
...
**This 1-page document provides Claude with everything needed to build a production-ready Real Estate Investment Finder in exactly 3 prompts!** 🚀
