...
services:
  - type: web
    name: automated-research-department-api
    env: python
...
NEXT_PUBLIC_API_BASE_URL=https://automated-research-department-api.onrender.com
...
"Create the FastAPI backend for the Automated Research Department with research specific endpoints and integrations. Include AI processing and specialized functionality."
...
**This 1-page document provides Claude with everything needed to build a production-ready Automated Research Department in exactly 3 prompts!** 🚀
