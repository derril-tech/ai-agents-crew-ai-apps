...
services:
  - type: web
    name: multimodal-ai-medical-assistant-api
    env: python
...
NEXT_PUBLIC_API_BASE_URL=https://multimodal-ai-medical-assistant-api.onrender.com
...
"Create the FastAPI backend for the Multimodal AI Medical Assistant with voice assistant specific endpoints and integrations. Include AI processing and specialized functionality."
...
**This 1-page document provides Claude with everything needed to build a production-ready Multimodal AI Medical Assistant in exactly 3 prompts!** 🚀
