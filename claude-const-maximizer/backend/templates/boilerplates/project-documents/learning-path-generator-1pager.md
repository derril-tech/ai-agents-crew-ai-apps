...
services:
  - type: web
    name: learning-path-generator-api
    env: python
...
NEXT_PUBLIC_API_BASE_URL=https://learning-path-generator-api.onrender.com
...
"Create the FastAPI backend for the Learning Path Generator with ai platform specific endpoints and integrations. Include AI processing and specialized functionality."
...
**This 1-page document provides Claude with everything needed to build a production-ready Learning Path Generator in exactly 3 prompts!** 🚀
