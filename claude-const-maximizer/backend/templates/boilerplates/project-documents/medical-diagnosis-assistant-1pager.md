...
services:
  - type: web
    name: medical-diagnosis-assistant-api
    env: python
...
NEXT_PUBLIC_API_BASE_URL=https://medical-diagnosis-assistant-api.onrender.com
...
"Create the FastAPI backend for the AI-Powered Medical Diagnosis Assistant with voice assistant specific endpoints and integrations. Include AI processing and specialized functionality."
...
**This 1-page document provides Claude with everything needed to build a production-ready AI-Powered Medical Diagnosis Assistant in exactly 3 prompts!** 🚀
