...
services:
  - type: web
    name: auto-blog-post-series-creator-api
    env: python
...
NEXT_PUBLIC_API_BASE_URL=https://auto-blog-post-series-creator-api.onrender.com
...
"Create the FastAPI backend for the Auto Blog Post Series Creator with ai platform specific endpoints and integrations. Include AI processing and specialized functionality."
...
**This 1-page document provides Claude with everything needed to build a production-ready Auto Blog Post Series Creator in exactly 3 prompts!** 🚀
