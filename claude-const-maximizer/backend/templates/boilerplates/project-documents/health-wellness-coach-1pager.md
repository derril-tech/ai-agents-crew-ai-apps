...
services:
  - type: web
    name: health-wellness-coach-api
    env: python
...
NEXT_PUBLIC_API_BASE_URL=https://health-wellness-coach-api.onrender.com
...
"Create the FastAPI backend for the AI-Powered Voice-Based Health & Wellness Coach with ai platform specific endpoints and integrations. Include AI processing and specialized functionality."
...
**This 1-page document provides Claude with everything needed to build a production-ready AI-Powered Voice-Based Health & Wellness Coach in exactly 3 prompts!** 🚀
