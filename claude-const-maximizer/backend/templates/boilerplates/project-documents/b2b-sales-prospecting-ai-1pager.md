...
services:
  - type: web
    name: b2b-sales-prospecting-ai-api
    env: python
...
NEXT_PUBLIC_API_BASE_URL=https://b2b-sales-prospecting-ai-api.onrender.com
...
"Create the FastAPI backend for the B2B Sales Prospecting AI with ai platform specific endpoints and integrations. Include AI processing and specialized functionality."
...
**This 1-page document provides Claude with everything needed to build a production-ready B2B Sales Prospecting AI in exactly 3 prompts!** 🚀
