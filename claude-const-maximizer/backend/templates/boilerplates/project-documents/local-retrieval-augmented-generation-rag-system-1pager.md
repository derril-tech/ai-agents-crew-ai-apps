...
services:
  - type: web
    name: local-retrieval-augmented-generation-rag-system-api
    env: python
...
NEXT_PUBLIC_API_BASE_URL=https://local-retrieval-augmented-generation-rag-system-api.onrender.com
...
"Create the FastAPI backend for the Local Retrieval-Augmented Generation (RAG) System with ai platform specific endpoints and integrations. Include AI processing and specialized functionality."
...
**This 1-page document provides Claude with everything needed to build a production-ready Local Retrieval-Augmented Generation (RAG) System in exactly 3 prompts!** 🚀
