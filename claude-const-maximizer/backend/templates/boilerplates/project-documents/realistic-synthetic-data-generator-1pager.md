...
services:
  - type: web
    name: realistic-synthetic-data-generator-api
    env: python
...
NEXT_PUBLIC_API_BASE_URL=https://realistic-synthetic-data-generator-api.onrender.com
...
"Create the FastAPI backend for the Realistic Synthetic Data Generator with ai platform specific endpoints and integrations. Include AI processing and specialized functionality."
...
**This 1-page document provides Claude with everything needed to build a production-ready Realistic Synthetic Data Generator in exactly 3 prompts!** 🚀
