...
services:
  - type: web
    name: interactive-storybook-creator-api
    env: python
...
NEXT_PUBLIC_API_BASE_URL=https://interactive-storybook-creator-api.onrender.com
...
"Create the FastAPI backend for the AI-Powered Interactive Storybook Creator with ai platform specific endpoints and integrations. Include AI processing and specialized functionality."
...
**This 1-page document provides Claude with everything needed to build a production-ready AI-Powered Interactive Storybook Creator in exactly 3 prompts!** 🚀
