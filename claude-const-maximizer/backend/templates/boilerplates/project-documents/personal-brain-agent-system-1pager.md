...
services:
  - type: web
    name: personal-brain-agent-system-api
    env: python
...
NEXT_PUBLIC_API_BASE_URL=https://personal-brain-agent-system-api.onrender.com
...
"Create the FastAPI backend for the Personal Brain Agent System with ai platform specific endpoints and integrations. Include AI processing and specialized functionality."
...
**This 1-page document provides Claude with everything needed to build a production-ready Personal Brain Agent System in exactly 3 prompts!** 🚀
