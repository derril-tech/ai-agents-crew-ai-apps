...
services:
  - type: web
    name: podcast-to-blog-post-converter-api
    env: python
...
NEXT_PUBLIC_API_BASE_URL=https://podcast-to-blog-post-converter-api.onrender.com
...
"Create the FastAPI backend for the Podcast to Blog Post Converter with ai platform specific endpoints and integrations. Include AI processing and specialized functionality."
...
**This 1-page document provides Claude with everything needed to build a production-ready Podcast to Blog Post Converter in exactly 3 prompts!** 🚀
