...
services:
  - type: web
    name: creative-content-generation-marketing-team-api
    env: python
...
NEXT_PUBLIC_API_BASE_URL=https://creative-content-generation-marketing-team-api.onrender.com
...
"Create the FastAPI backend for the Creative Content Generation and Marketing Team with content generation specific endpoints and integrations. Include AI processing and specialized functionality."
...
**This 1-page document provides Claude with everything needed to build a production-ready Creative Content Generation and Marketing Team in exactly 3 prompts!** 🚀
