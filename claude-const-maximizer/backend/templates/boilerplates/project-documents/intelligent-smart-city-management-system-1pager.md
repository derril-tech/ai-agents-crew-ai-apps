...
services:
  - type: web
    name: intelligent-smart-city-management-system-api
    env: python
...
NEXT_PUBLIC_API_BASE_URL=https://intelligent-smart-city-management-system-api.onrender.com
...
"Create the FastAPI backend for the Intelligent Smart City Management System with ai platform specific endpoints and integrations. Include AI processing and specialized functionality."
...
**This 1-page document provides Claude with everything needed to build a production-ready Intelligent Smart City Management System in exactly 3 prompts!** 🚀
